...
### flowMode
<b>Новый парамет, пока доступный в этой ветке. Хранит в себе булевое значение.</b> Вводит программу в режим потока, благодаря чему расписание будет обновляться каждую секунду. Для прекращения выполнения программы можно нажать кнопку <code>Enter</code>.