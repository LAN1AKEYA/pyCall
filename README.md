...
### flowMode
<b>Новый парамет, пока доступный только в этой ветке.</b> Хранит в себе булевое значение. Вводит программу в режим потока, благодаря чему расписание будет обновляться каждую секунду.  
Для прекращения выполнения программы можно нажать кнопку <code>Enter</code>.